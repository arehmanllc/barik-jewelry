const Header = {
  ...
  prepareSticky: function prepareSticky() {
    let isMobile = window.innerWidth < 767,
        ...
        announcementCarousel = document.querySelector(".shopify-section-group-header-group .js-announcement-carousel"),
        isSticky = false,
    ...
    switch ( isMobile ) {
      case true:
        ...
        if (announcementCarousel) {
          amountToScroll = announcementCarousel.clientHeight;
        }
        break;
      case false:
        amountToScroll = 0;
        if (topBar) {
          if (announcementCarousel) {
            amountToScroll = topBar.clientHeight + announcementCarousel.clientHeight;
          } else {
            amountToScroll = topBar.clientHeight;
          }
        } else if (announcementCarousel) {
          amountToScroll = announcementCarousel.clientHeight;
        }
